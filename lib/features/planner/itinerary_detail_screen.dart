      ...
      children: [
        Row(
          children: [
            ...
            const SizedBox(width: 8),
            Expanded(
              child: Text(rideMeta(leg, l10n), maxLines: 1, overflow: TextOverflow.ellipsis,
                  style: Theme.of(context).textTheme.bodySmall?.copyWith(color: scheme.onSurfaceVariant)),
            ),
          ],
        ),
        const SizedBox(height: 4),
        Text(l10n.onDemandDestination(leg.to.name), maxLines: 2, overflow: TextOverflow.ellipsis,
