...
/// Pill showing a route's short name in its brand colour.
class RouteChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bg = r == null
        ...
        : colorFromHex(r.color, fallback: componentColor(r.component));
    final fg = r == null
        ? Theme.of(context).colorScheme.onSurfaceVariant
        : colorFromHex(r.textColor, fallback: onColor(bg));
    final icon = modeIcon(r?.mode ?? mode ?? TravelMode.walk);
    return Container(
...
String componentLabel(Component? c, AppLocalizations l10n) => switch (c) {
