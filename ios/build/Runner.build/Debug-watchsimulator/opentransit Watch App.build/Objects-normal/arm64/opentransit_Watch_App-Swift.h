...
#ifndef OPENTRANSIT_WATCH_APP_SWIFT_H
#define OPENTRANSIT_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="opentransit_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21opentransit_Watch_App10WatchStore")
@interface WatchStore : NSObject
...
@class WCSession;
@class NSString;
@interface WatchStore (SWIFT_EXTENSION(opentransit_Watch_App)) <WCSessionDelegate>
